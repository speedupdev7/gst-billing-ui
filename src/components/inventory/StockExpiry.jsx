...
import { Search, Plus, AlertTriangle, Calendar, Download } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-100 p-3 md:p-4">
      ...
      <div className="bg-white rounded-xl shadow-sm p-3 border border-gray-200">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
          <div>
            <h1 className="text-lg font-bold text-gray-800">Stock Expiry</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mt-4">
        <div className="bg-white rounded-xl p-3 shadow-sm border border-gray-200">
          <p className="text-xs text-gray-500">Total Expiry Items</p>

          <h2 className="text-lg font-bold mt-1">34</h2>
        </div>

        <div className="bg-white rounded-xl p-3 shadow-sm border border-gray-200">
          <p className="text-xs text-gray-500">Critical Expiry</p>

          <h2 className="text-lg font-bold mt-1 text-red-500">5</h2>
        </div>

        <div className="bg-white rounded-xl p-3 shadow-sm border border-gray-200">
          <p className="text-xs text-gray-500">Expiring This Month</p>

          <h2 className="text-lg font-bold mt-1 text-orange-500">12</h2>
        </div>

        <div className="bg-white rounded-xl p-3 shadow-sm border border-gray-200">
          <div className="flex justify-between items-center">
            <div>
              <p className="text-xs text-gray-500">Safe Stock</p>

              <h2 className="text-lg font-bold mt-1 text-green-600">17</h2>
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 mt-4 overflow-hidden">
            ...
            <tbody>
              {expiryData.map((stock, index) => (
                ...
                >
                  ...
                  <td className="px-3 py-2 text-xs">{stock.qty}</td>
        ...
        <div className="p-3 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between gap-2">
          <p className="text-xs text-gray-500">Showing 1 to 3 of 34 entries</p>
